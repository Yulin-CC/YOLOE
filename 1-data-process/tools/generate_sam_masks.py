...
SAM2_CHECKPOINT = REPO_ROOT / "weights" / "sam2.1_hiera_large.pt"
# hydra 配置名；对应文件 third_party/sam2/sam2/configs/sam2.1/sam2.1_hiera_l.yaml（需 pip install -e third_party/sam2/）

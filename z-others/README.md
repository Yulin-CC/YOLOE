...
[arXiv](https://arxiv.org/abs/2503.07465) [Hugging Face Models](https://huggingface.co/jameslahm/yoloe/tree/main) [Hugging Face Spaces](https://huggingface.co/spaces/jameslahm/yoloe) [Colab](https://colab.research.google.com/github/roboflow-ai/notebooks/blob/main/notebooks/zero-shot-object-detection-and-segmentation-with-yoloe.ipynb) [Hugging Face Collection](https://huggingface.co/collections/jameslahm/yoloe-67d5110aabaefbe129c15917) [Openbayes Demo](https://openbayes.com/console/public/tutorials/BQhUorEqyVX)
...
- *Standard APm* is reported on LVIS `val` set with text (T) / visual (V) prompts.
